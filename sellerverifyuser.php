    ...
    if(isset($_POST['uemail']) && isset($_POST['upass']) 
       && !empty($_POST['uemail']) && !empty($_POST['upass'])){
        ...
        try{
            ...
            $sqlquery="SELECT id, email FROM seller WHERE email='$var1' and password='$var2'";
                ...
                if($returnval->rowCount()==1){
                    ...
                    ?>
                        <script>
                            ...
                            window.location.assign('sellerhomepage.php');
                        </script>
                    <?php
                }
                else{
                    ...
                    ?>
                        <script>
                            ...
                            window.location.assign('sellerloginpage.php');
                        </script>
                    <?php
                }
            }
